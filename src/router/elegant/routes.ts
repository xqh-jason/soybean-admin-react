        ...
        children: [
          {
            ...
            name: '(base)_home',
            path: '/home',
            handle: { i18nKey: 'route.(base)_home', icon: 'mdi:monitor-dashboard', title: 'home' }
          },
          {
            matchedFiles: [null, '/src/pages/(base)/label-manage/index.tsx', null, null],
            name: '(base)_label-manage',
            path: '/label-manage',
            handle: { i18nKey: 'route.(base)_label-manage', title: '(base)_label-manage', roles: ['LabelManage'] },
            children: [
              {
                matchedFiles: [null, '/src/pages/(base)/label-manage/product-labels/index.tsx', null, null],
                name: '(base)_label-manage_product-labels',
                path: '/label-manage/product-labels',
                handle: {
                  i18nKey: 'route.(base)_label-manage_product-labels',
                  title: '(base)_label-manage_product-labels',
                  roles: ['ProductLabels']
                }
              }
            ]
            ...
            children: [
              {
                ...
                name: '(base)_shein-listing_full-care-mode',
