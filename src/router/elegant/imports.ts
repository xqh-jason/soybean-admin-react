...
"(base)_label-manage": () => import("@/pages/(base)/label-manage/index.tsx"),
"(base)_label-manage_product-labels": () => import("@/pages/(base)/label-manage/product-labels/index.tsx"),
"(base)_shein-listing_full-care-mode": () => import("@/pages/(base)/sheIn-listing/full-care-mode/index.tsx"),
"(base)_shein-listing": () => import("@/pages/(base)/sheIn-listing/index.tsx"),
